...
const Footer = () => {
    return (
        <div>
            <footer className="footer p-10 bg-gradient-to-r from-violet-400 to-fuchsia-400 text-base-content">
  <div className='text-white font-medium'>
    <span className="pl-5 footer-title font-bold text-white-500">RecipeHub</span> 
    <p className='pl-5'>Recipes easy and quick in the Kitchen</p>
    <div className="lg:ml-6 form-control">
                            <div className="input-group">
                                <input type="text" placeholder="Search Recipe Here" className="input input-bordered" />
                                <button className="btn btn-square bg-tealt-400 border-none">
...
<footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
  <div className="items-center grid-flow-col">
    ...
    <p>RecipeHub <br/>Providing Recipes of italian cuisine 2020</p>
  </div> 
